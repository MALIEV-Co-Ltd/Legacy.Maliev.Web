...
namespace Legacy.Maliev.Web.Pages
{
    ...
    internal static class PublicSearchRouteCatalog
    {
        ...
        internal static IReadOnlyList<PublicSearchRoute> Routes { get; } = new[]
        {
            ...
            new PublicSearchRoute("/services/3d-design", "monthly", 0.9),
            new PublicSearchRoute("/services/silicone-casting", "monthly", 0.9),
            new PublicSearchRoute("/services/low-volume-injection-molding", "monthly", 0.9),
            ...
            new PublicSearchRoute("/services/finishing-and-color", "monthly", 0.7),
