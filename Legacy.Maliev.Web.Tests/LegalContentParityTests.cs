...
public sealed class LegalContentParityTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> factory;

    public LegalContentParityTests(WebApplicationFactory<Program> factory)
    {
