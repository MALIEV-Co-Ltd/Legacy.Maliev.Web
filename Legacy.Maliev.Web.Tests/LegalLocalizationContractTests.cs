...
public sealed class LegalLocalizationContractTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public static TheoryData<string, string[], string[]> ThaiLegalDocuments => new()
    {
        ...
        },
        {
            ...
            [
                "ข้อกำหนดและเงื่อนไข", "คุกกี้", "สิทธิ์การใช้งาน",
                "การเชื่อมโยงมายังเนื้อหาของเรา", "เฟรมและการฝังหน้าเว็บ", "การสงวนสิทธิ์",
                "การแจ้งลิงก์ที่ไม่เหมาะสม", "ความรับผิดชอบต่อเนื้อหา", "ข้อสงวนสิทธิ์",
            ],
