...
public sealed partial class KnowledgeThreeDimensionalScanningStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public KnowledgeThreeDimensionalScanningStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
