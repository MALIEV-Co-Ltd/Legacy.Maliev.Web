...
public sealed class BlazorHostFoundationTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly HttpClient client;

    public BlazorHostFoundationTests(TestingWebApplicationFactory factory)
    {
