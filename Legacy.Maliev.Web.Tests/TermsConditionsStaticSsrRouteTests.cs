...
public sealed partial class TermsConditionsStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public TermsConditionsStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
