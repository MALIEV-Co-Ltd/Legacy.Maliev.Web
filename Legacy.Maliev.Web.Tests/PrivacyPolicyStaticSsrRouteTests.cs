...
public sealed class PrivacyPolicyStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public PrivacyPolicyStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
