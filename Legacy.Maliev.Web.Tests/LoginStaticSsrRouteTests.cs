...
public sealed class LoginStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public LoginStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
