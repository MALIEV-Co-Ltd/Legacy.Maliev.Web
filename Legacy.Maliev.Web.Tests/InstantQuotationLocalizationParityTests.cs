...
public sealed partial class InstantQuotationLocalizationParityTests
{
    private static readonly IReadOnlyDictionary<string, string> ReviewedThaiTranslations =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["0.12 mm layers, reduced speed and acceleration, Gyroid sparse infill"] = "ชั้นพิมพ์ 0.12 มม. ลดความเร็วและความเร่ง ใช้อินฟิลล์แบบ Gyroid",
            ["0.20 mm layers, 3 walls, 15% sparse infill"] = "ชั้นพิมพ์ 0.20 มม. ผนัง 3 ชั้น อินฟิลล์ 15%",
            ["6 walls, 2 mm top and bottom shells, denser sparse infill"] = "ผนัง 6 ชั้น ผิวบนและล่างหนา 2 มม. และใช้อินฟิลล์ที่หนาแน่นขึ้น",
