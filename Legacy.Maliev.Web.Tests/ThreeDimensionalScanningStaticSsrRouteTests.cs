...
public sealed partial class ThreeDimensionalScanningStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public ThreeDimensionalScanningStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
