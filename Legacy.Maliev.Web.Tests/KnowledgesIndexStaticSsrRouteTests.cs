...
public sealed partial class KnowledgesIndexStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public KnowledgesIndexStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
