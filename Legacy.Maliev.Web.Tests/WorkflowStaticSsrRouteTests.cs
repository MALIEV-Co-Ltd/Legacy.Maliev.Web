...
public sealed partial class WorkflowStaticSsrRouteTests : IClassFixture<TestingWebApplicationFactory>
{
    private readonly WebApplicationFactory<Program> factory;

    public WorkflowStaticSsrRouteTests(TestingWebApplicationFactory factory)
    {
