...
| `b220158` | Migrated | Opaque transactional credential callbacks in `4283bfa`/`3546120`; Auth counterpart `f24d97f`. |
...
| `e25c833` | Migrated | First-login required actions and set-initial-password flow in `3546120`; Auth counterpart `f24d97f`. |
...
1. Land AuthService commit `f24d97f` before enabling the first-login Web flow outside local review.
